	...
	function setData() {
		<%
			...
			<%}
		        ...
		        document.getElementById('bmonth').value = '<%=objListBean.getBirthMonth()%>';
	...
	<s:form action="/updateDetails" onsubmit="return checkEmpty()"
		...
		<table class="table1">
			...
			<tr>
				...
				<td><s:reset styleClass="button1 button2" onclick="location='http://localhost:8080/Day5Assignment1/UpdateUserDetails.jsp"><bean:message key="button.search.clear" /></s:reset>
				</td>
			</tr>
		</table>
		<div
